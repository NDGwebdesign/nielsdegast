    ...
    <main class="max-w-7xl mx-auto px-6">
        ...
        <section class="hero min-h-[80vh] flex flex-col items-center justify-center text-center py-16">
            ...
            <div class="subscriber-counter mb-6">
                <div class="counter-box bg-gradient-to-br from-gray-900 to-black p-8 rounded-2xl inline-block shadow-lg">
        ...
        <section class="latest-content py-12">
            ...
            <div id="latestVideos" class="video-grid flex flex-wrap justify-center gap-8">
        ...
        <section class="content-highlights py-12">
            ...
            <div class="highlights-grid grid md:grid-cols-3 gap-8">
                <div class="highlight-card bg-gradient-to-br from-gray-900 to-black p-8 rounded-2xl text-center transition-transform transform hover:-translate-y-1">
        ...
        <section class="about-preview py-12">
            <div class="about-content max-w-4xl mx-auto text-center">
                ...
                <p class="text-gray-300 mb-6">
                    Hey! Ik ben Niels de Gast, een Nederlandse content creator gespecialiseerd in gaming en entertainment. 
                    Op mijn kanaal deel ik mijn passie voor gaming, muziek en entertainment met jullie. 
                    Van epische gameplay momenten tot muzikale video's en vermakelijke reactie video's - er is voor ieder wat wils!
                </p>
                ...
                <a href="?page=aboutme" class="read-more cta-button inline-block bg-red-600 text-white px-8 py-4 rounded-full font-semibold transition-transform transform hover:-translate-y-1 hover:shadow-lg">
                    Lees meer over mij →
                </a>
            </div>
        </section>
        ...
        <section class="social-connect py-12">
            ...
            <div class="social-grid grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                <a href="https://discord.gg/PPVBhBemSf" class="social-card flex items-center justify-center gap-4 p-6 rounded-lg bg-[#7289da] text-white hover:-translate-y-1 transition-transform">
                    <i class="fab fa-discord text-2xl"></i>
                    <span>Join Discord</span>
                </a>
                <a href="https://www.tiktok.com/@nielsdegastyt" class="social-card flex items-center justify-center gap-4 p-6 rounded-lg bg-black text-white hover:-translate-y-1 transition-transform">
                    <i class="fab fa-tiktok text-2xl"></i>
                    <span>TikTok</span>
                </a>
                <a href="https://open.spotify.com/artist/6EyPJVn7KN6SIkhtiMY0fT" class="social-card flex items-center justify-center gap-4 p-6 rounded-lg bg-[#1DB954] text-white hover:-translate-y-1 transition-transform">
